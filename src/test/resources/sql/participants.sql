...
VALUES (gen_random_uuid(), 'Alex', 'Sidorov', 'alex@webclient.ru', '+79001112233', now()),
       ...
       ('223e4567-e89b-12d3-a456-426614174001', 'Удален', 'Удаленный', 'delete@webclient.ru', '+79005554433', now());